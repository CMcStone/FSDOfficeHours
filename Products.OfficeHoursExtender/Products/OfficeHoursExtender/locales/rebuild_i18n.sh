...
i18ndude rebuild-pot --pot ./FSDOfficeHoursExtender.pot --create FSDOfficeHoursExtender ../ || exit 1
i18ndude sync --pot ./FSDOfficeHoursExtender.pot ./*/LC_MESSAGES/FSDOfficeHoursExtender.po
